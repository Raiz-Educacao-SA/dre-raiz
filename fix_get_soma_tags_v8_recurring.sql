-- ═══════════════════════════════════════════════════════════════════
-- fix_get_soma_tags_v8_recurring.sql
-- Adiciona parâmetro p_recurring para filtrar por recorrência
-- NULL = todos | 'Sim' = apenas recorrentes | 'Não' = apenas não-recorrentes
-- COALESCE(t.recurring, 'Sim') trata registros sem valor como recorrentes
