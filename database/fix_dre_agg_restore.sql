...
-- EMERGÊNCIA: restaura dre_agg com schema correto + recurring INITCAP
-- + restaura get_dre_dimension com filtro recurring
-- + restaura get_dre_filter_options
--
...
-- ══════════════════════════════════
-- PARTE 1: Normalizar dados existentes (one-time)
-- ══════════════════════════════════
...
-- ══════════════════════════════════
-- PARTE 2: Recriar dre_agg com schema CORRETO + recurring
-- Colunas: tag0, tag01, tag02, tag03, conta_contabil, vendor,
--          year_month, scenario, marca, nome_filial, recurring,
...
-- ══════════════════════════════════
-- PARTE 3: Restaurar get_dre_dimension COM filtro recurring
-- ══════════════════════════════════
...
-- ══════════════════════════════════
-- PARTE 4: Restaurar get_dre_filter_options
-- ══════════════════════════════════
...
-- ══════════════════════════════════
-- PARTE 5: Atualizar get_soma_tags com INITCAP
-- ══════════════════════════════════
