-- ═══════════════════════════════════════════════════════════════════
-- RPC v2: get_filtered_transactions_page
-- NOVIDADE: p_skip_count pula o COUNT(*) na primeira página
-- IMPORTANTE: Dropar v1 antes (assinatura diferente)
-- ═══════════════════════════════════════════════════════════════════

-- 1. Dropar versão antiga (sem p_skip_count)
...
-- 2. Criar versão nova (com p_skip_count)
...
BEGIN
  ...
  -- COUNT: pular se p_skip_count = true (primeira página não precisa do total exato)
