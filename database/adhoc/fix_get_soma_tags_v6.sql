-- ═══════════════════════════════════════════════════════════════════
-- fix_get_soma_tags_v6.sql
-- Adiciona parâmetro p_tags02 para filtrar por tag02
-- ═══════════════════════════════════════════════════════════════════
...
-- SELECT * FROM get_soma_tags('2026-01','2026-12', NULL, NULL, ARRAY['Algum Tag02']) LIMIT 30;
