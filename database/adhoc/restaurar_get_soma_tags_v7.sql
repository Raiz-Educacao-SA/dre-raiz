-- ═══════════════════════════════════════════════════════════════════
-- restaurar_get_soma_tags_v7.sql
-- Restaura get_soma_tags para versão original (v7) sem p_recurring
-- ═══════════════════════════════════════════════════════════════════

-- Remove todas as sobrecargas criadas durante as tentativas
...
GRANT EXECUTE ON FUNCTION get_soma_tags(text, text, text[], text[], text[], text[]) TO authenticated;
GRANT EXECUTE ON FUNCTION get_soma_tags(text, text, text[], text[], text[], text[]) TO anon;
