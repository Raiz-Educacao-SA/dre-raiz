-- ═══════════════════════════════════════════════════════════════════
-- OTIMIZAÇÃO: Pular COUNT(*) na primeira página
-- O COUNT(*) faz full-scan dos filtrados e é o maior gargalo.
-- Com p_skip_count = true, retorna total_count = -1 (desconhecido)
-- e o front-end mostra "1000+" até o usuário navegar páginas.
-- ═══════════════════════════════════════════════════════════════════
