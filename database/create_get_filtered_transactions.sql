-- ═══════════════════════════════════════════════════════════════════
-- RPC: get_filtered_transactions_page
-- Substitui query direta na tabela transactions (bloqueada por RLS)
-- SECURITY DEFINER bypassa RLS (mesmo padrão de get_soma_tags)
-- ═══════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- Filtro recurring (com variações de case/acento)
  ...
  -- Contar total (mesmos filtros, sem ORDER/LIMIT)
