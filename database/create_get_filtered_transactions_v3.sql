-- ═══════════════════════════════════════════════════════════════════
-- RPC v3: get_filtered_transactions_page
-- NOVIDADE: p_tag0 para filtrar diretamente pela coluna tag0
-- IMPORTANTE: Dropar v2 antes (assinatura diferente)
-- ═══════════════════════════════════════════════════════════════════

-- 1. Dropar versão v2 (sem p_tag0)
...
BEGIN
  ...
  -- COUNT: pular se p_skip_count = true
