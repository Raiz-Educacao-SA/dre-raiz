-- ═══════════════════════════════════════════════════════════════════
-- get_soma_tags v10 + vendor — baseado em fix_get_soma_tags_v10_no_join
-- Adiciona p_vendor sem alterar lógica existente
...
GRANT EXECUTE ON FUNCTION get_soma_tags(text, text, text[], text[], text[], text[], text, text[], text[]) TO authenticated;
GRANT EXECUTE ON FUNCTION get_soma_tags(text, text, text[], text[], text[], text[], text, text[], text[]) TO anon;
