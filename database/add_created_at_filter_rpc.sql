-- ============================================================
-- Filtro por data de lançamento (created_at) na RPC paginada
-- Adiciona p_created_from e p_created_to como parâmetros
...
CREATE OR REPLACE FUNCTION get_filtered_transactions_page(
  ...
  p_created_from  text    DEFAULT NULL,   -- YYYY-MM-DD (data de lançamento de)
  p_created_to    text    DEFAULT NULL,   -- YYYY-MM-DD (data de lançamento até)
