...
export const ALPHA_PIPELINE: PipelineStep[] = [
  ...
  {
    step_order: 8,
    agent_code: 'executivo',
    step_type: 'review',
    label: 'Executive Review & Decision Readiness',
    receives_from: ['alex', 'bruna', 'carlos', 'denilson', 'edmundo', 'falcao'],
    output_contract: 'ExecutiveReviewOutput',
    gate_description: 'Perguntas executivas geradas, ownership cobrado, fragilidades expostas, prontidão avaliada, ensaio executivo completo.',
    next_agent: 'end',
    can_block_pipeline: false,
  },
];
