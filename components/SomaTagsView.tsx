              ...
              <React.Fragment key={m}>
                {activeElements.map(el => {
                  switch (el) {
                    ...
                    case 'DeltaAbsOrcado':  return <td key="dao" className={`px-0.5 text-center font-mono text-[12px] font-black w-[85px] ${md.orcado !== 0 ? deltaClass(dOrçM, md.orcado, true) : 'text-orange-300'} ${mesFirstCol === 'deltaAbsOrcado' ? 'border-l-2 border-l-white/30' : ''}`}>{md.orcado !== 0 ? fmtK(dOrçM) : '—'}</td>;
                    ...
                    case 'DeltaAbsA1':      return <td key="da1" className={`px-0.5 text-center font-mono text-[12px] font-black w-[85px] ${md.a1 !== 0 ? deltaClass(dA1M, md.a1, true) : 'text-orange-300'} ${mesFirstCol === 'deltaAbsA1' ? 'border-l-2 border-l-white/30' : ''}`}>{md.a1 !== 0 ? fmtK(dA1M) : '—'}</td>;
                        ...
                        <React.Fragment key={m}>
                          {activeElements.map(el => {
                            switch (el) {
                              ...
                              case 'DeltaAbsOrcado':  return <td key="dao" className={`px-0.5 py-1 text-center font-mono font-black text-[12px] w-[85px] bg-white/10 ${md.orcado !== 0 ? deltaClass(dOrçM, md.orcado) : 'text-gray-300'} ${mesFirstCol === 'deltaAbsOrcado' ? 'border-l-2 border-l-white/20' : ''}`}>{md.orcado !== 0 ? fmtK(dOrçM) : '—'}</td>;
                              ...
                              case 'DeltaAbsA1':      return <td key="da1" className={`px-0.5 py-1 text-center font-mono font-black text-[12px] w-[85px] bg-white/10 ${md.a1 !== 0 ? deltaClass(dA1M, md.a1) : 'text-gray-300'} ${mesFirstCol === 'deltaAbsA1' ? 'border-l-2 border-l-white/20' : ''}`}>{md.a1 !== 0 ? fmtK(dA1M) : '—'}</td>;
                            ...
                            <React.Fragment key={m}>
                              {activeElements.map(el => {
                                switch (el) {
                                  ...
                                  case 'DeltaAbsOrcado':  return <td key="dao" className={`px-0.5 py-0.5 text-center font-mono text-[12px] w-[85px] ${md.orcado !== 0 ? deltaClass(dOrçM, md.orcado) : 'text-gray-300'} ${mesFirstCol === 'deltaAbsOrcado' ? 'border-l-2 border-l-gray-200' : ''}`}>{md.orcado !== 0 ? fmtK(dOrçM) : <span className="text-gray-300">—</span>}</td>;
                                  ...
                                  case 'DeltaAbsA1':      return <td key="da1" className={`px-0.5 py-0.5 text-center font-mono text-[12px] w-[85px] ${md.a1 !== 0 ? deltaClass(dA1M, md.a1) : 'text-gray-300'} ${mesFirstCol === 'deltaAbsA1' ? 'border-l-2 border-l-gray-200' : ''}`}>{md.a1 !== 0 ? fmtK(dA1M) : <span className="text-gray-300">—</span>}</td>;
                    ...
                    <React.Fragment key={m}>
                      {activeElements.map(el => {
                        switch (el) {
                          ...
                          case 'DeltaAbsOrcado':  return <td key="dao" className={`px-0.5 py-2 text-center font-mono text-[12px] font-black w-[85px] bg-white/10 ${md.orcado !== 0 ? deltaClass(dOrçM, md.orcado, true) : 'text-gray-400'} ${mesFirstCol === 'deltaAbsOrcado' ? 'border-l-2 border-l-white/20' : ''}`}>{md.orcado !== 0 ? fmtK(dOrçM) : '—'}</td>;
                          ...
                          case 'DeltaAbsA1':      return <td key="da1" className={`px-0.5 py-2 text-center font-mono text-[12px] font-black w-[85px] bg-white/10 ${md.a1 !== 0 ? deltaClass(dA1M, md.a1, true) : 'text-gray-400'} ${mesFirstCol === 'deltaAbsA1' ? 'border-l-2 border-l-white/20' : ''}`}>{md.a1 !== 0 ? fmtK(dA1M) : '—'}</td>;
                  ...
                  <tr className="bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 text-white font-black text-[12px] shadow-[0_-2px_6px_rgba(0,0,0,0.3)] border-t-2 border-yellow-400">
                    ...
                    {activeElements.map(el => {
                      switch (el) {
                        ...
                        case 'DeltaAbsOrcado':  return <td key="dao"  className={`px-2 py-2 text-center font-mono ${totals.orcado !== 0 ? deltaClass(totals.real - totals.orcado, totals.orcado, true) : 'text-gray-500'}`}>{totals.orcado !== 0 ? fmt(totals.real - totals.orcado) : '—'}</td>;
                        case 'DeltaPercOrcado': return <td key="dpo"  className={`px-2 py-2 text-center font-mono border-r border-white/10 ${totals.orcado !== 0 ? deltaClass(totals.real - totals.orcado, totals.orcado, true) : 'text-gray-500'}`}>{fmtPct(totals.real, totals.orcado)}</td>;
                        case 'A1':              return <td key="a1"   className={`px-2 py-2 text-center font-mono ${totals.a1 !== 0 ? '' : 'text-gray-500'}`}>{totals.a1 !== 0 ? fmt(totals.a1) : '—'}</td>;
                        case 'DeltaAbsA1':      return <td key="da1"  className={`px-2 py-2 text-center font-mono ${totals.a1 !== 0 ? deltaClass(totals.real - totals.a1, totals.a1, true) : 'text-gray-500'}`}>{totals.a1 !== 0 ? fmt(totals.real - totals.a1) : '—'}</td>;
                        case 'DeltaPercA1':     return <td key="dp1"  className={`px-2 py-2 text-center font-mono ${totals.a1 !== 0 ? deltaClass(totals.real - totals.a1, totals.a1, true) : 'text-gray-500'}`}>{fmtPct(totals.real, totals.a1)}</td>;
                        default: return null;
                      }
                    })}
                  </tr>
